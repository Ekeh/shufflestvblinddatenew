...
$msg="<div class='alert alert-block alert-danger'> Phone Number Appears Incorrect : Must be 10 Characters</div>";
}else
*/if($stremail=='' || $strpassword=='' || $gender=='' ){
$msg= '<div class="alert alert-block alert-danger"> You have left a required field blank</div>';
}else{
...
$msg="<div class='alert alert-block alert-danger'> Failed: Email - <b>".$stremail."</b>  already exists.</div>";
}else{

$msg="<div class='alert alert-block alert-danger'> Failed: Phone - <b>".$strphone."</b>  already exists.</div>";
}
...
<head>
	...
	<title>ShufflesTV – Sign up</title>
</head>
				...
				<div class="col-12">
					<div class="sign__content">
                        ...
                        <form action="" class="sign__form" method="post">
                            ...
                            <?php if($msg!=''){ ?> <?php echo $msg; ?>   <?php }else{ ?>  <!--<div class="alert alert-info"><label>We will send an activation code to your phone number.</label></div>-->  <?php } ?>

                            <div class="sign__group">
								<input type="email" class="sign__input" value="<?=$stremail?>" required name="email" placeholder="Email">
							</div>

							<div class="sign__group">
                                <div class="row">
                                    <div class="col-5">
                                        <select name="countryCode" required id="countryCode" class="sign__input" >
                                    ...
                                    <div class="col-7">
                                        <input type="text" class="sign__input" required name="phone" value="<?=$phone?>" placeholder="Phone Number">
                                    </div>
                                </div>
                        		</div>
                            <div class="sign__group">
                                <select class="sign__input" name="gender" required="">
							...
							<div class="sign__group">
								<input type="password" id="password" required name="password" onkeyup='check();' class="sign__input" placeholder="Password">
							</div>

                            <div class="sign__group">
                                <input type="password" required id="confirmpassword" name="confirmpassword" onkeyup='check();' class="sign__input" placeholder="Confirm Password">
                                <div><span id="confirm_pass_val"></span></div>
                            </div>

                           <!-- <div class="sign__group">
                                <input type="text" value="<?/*=$refid*/?>" name="refid" class="sign__input" placeholder="Referral ID">
                                <span style="font-size: 10px" class="sign__text">If you were referred, use the person's ID here or Skip (OPTIONAL) </span>
                            </div>-->

                            <div class="sign__group sign__group--checkbox">
								<input id="remember" name="remember" type="checkbox" required checked="checked">
                                <label for="remember">I agree to the  <a href="index.php?p=tandc">terms and conditions</a></a></label>
							</div>
							
							<button class="sign__btn" type="submit" name="joinnow" value="Submit">Sign up</button>
