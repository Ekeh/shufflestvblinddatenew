                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="main__table-text">
                                                    <a href="https://www.youtube.com/watch?v=YFY2A9mKucs" target="_blank" class="btn btn-default margin-right-20">
                                                        <span>YouTube</span>
                                                    </a>
                                                    <a href="" onclick="return confirm('You will be charged N<?=EPISODE_VIEW_AMOUNT?> per view from your wallet to view this episode. Do you want to continue?')" class="btn btn-success margin-right-20">
